...
areaDaPintura = float(input("Qual a área a ser pintada? (m²): "))
latas = math.ceil(areaDaPintura / 54)
valor = latas * 80

print("Você deverá comprar %.0f latas de tinta" % latas)
print("Custarão R$ %.2f" % valor)
